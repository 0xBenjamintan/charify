      ...
      <div className="flex flex-col md:flex-row">
        <div className="mt-4 md:mt-0 flex flex-col justify-center">
          ...
          <p className="text-xl mt-8 text-justify">
            ...
            it incredibly simple for you to make a positive impact on the crypto
            community and support charitable causes. Our platform allows you to
            burn unwanted or low-value{" "}
            <span className="text-gradient">NFTs</span>, and in return,
            you&rsquo;ll receive rewards and contribute to a better ecosystem.
          </p>
