...
import { vaultTransactionMessageBeet, } from '../types/VaultTransactionMessage';
 ...
 * @category generated
 */
export class VaultBatchTransaction {
    bump;
    ...
    static fromArgs(args) {
        return new VaultBatchTransaction(args.bump, args.ephemeralSignerBumps, args.message);
    }
    /**
    ...
    static async fromAccountAddress(connection, address, commitmentOrConfig) {
        ...
        if (accountInfo == null) {
            throw new Error(`Unable to find VaultBatchTransaction account at ${address}`);
        }
    ...
    static gpaBuilder(programId = new web3.PublicKey('SQDS4ep65T869zMMBKyuUq6aD6EgTu8psMjkvj52pCf')) {
        return beetSolana.GpaBuilder.fromStruct(programId, vaultBatchTransactionBeet);
    }
    /**
    ...
    static async getMinimumBalanceForRentExemption(args, connection, commitment) {
        return connection.getMinimumBalanceForRentExemption(VaultBatchTransaction.byteSize(args), commitment);
    }
    /**
...
], VaultBatchTransaction.fromArgs, 'VaultBatchTransaction');
