...
import { spendingLimitUseArgsBeet, } from '../types/SpendingLimitUseArgs';
/**
 ...
 * @category generated
 */
export function createSpendingLimitUseInstruction(accounts, args, programId = new web3.PublicKey('SQDS4ep65T869zMMBKyuUq6aD6EgTu8psMjkvj52pCf')) {
    ...
    if (accounts.mint != null) {
        if (accounts.systemProgram == null) {
            throw new Error("When providing 'mint' then 'accounts.systemProgram' need(s) to be provided as well.");
        }
        keys.push({
    ...
    if (accounts.vaultTokenAccount != null) {
        if (accounts.systemProgram == null || accounts.mint == null) {
            throw new Error("When providing 'vaultTokenAccount' then 'accounts.systemProgram', 'accounts.mint' need(s) to be provided as well.");
        }
        keys.push({
    ...
    if (accounts.destinationTokenAccount != null) {
        if (accounts.systemProgram == null ||
            ...
            throw new Error("When providing 'destinationTokenAccount' then 'accounts.systemProgram', 'accounts.mint', 'accounts.vaultTokenAccount' need(s) to be provided as well.");
        }
        keys.push({
    ...
    if (accounts.tokenProgram != null) {
        if (accounts.systemProgram == null ||
            ...
            throw new Error("When providing 'tokenProgram' then 'accounts.systemProgram', 'accounts.mint', 'accounts.vaultTokenAccount', 'accounts.destinationTokenAccount' need(s) to be provided as well.");
        }
        keys.push({
